...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 25%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
        ...
        <div class="text-center">
            <asp:GridView ID="gvHorariosMedicos" CssClass="table table-hover" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True" OnRowEditing="gvHorariosMedicos_RowEditing" OnRowCancelingEdit="gvHorariosMedicos_RowCancelingEdit" OnRowUpdating="gvHorariosMedicos_RowUpdating" AutoGenerateDeleteButton="True" OnRowDeleting="gvHorariosMedicos_RowDeleting">
                <Columns>
