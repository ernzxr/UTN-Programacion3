...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 50%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
        ...
        <asp:CustomValidator ID="cvExisteLegajo" OnServerValidate="cvExisteLegajo_ServerValidate" runat="server" ForeColor="#CC0000" ValidationGroup="gpAgregar" Display="Dynamic" ControlToValidate="txtUsuario">(*) El legajo ingresado ya existe.></asp:CustomValidator>
        ...
        <asp:RequiredFieldValidator ID="rfvGenero" runat="server" ControlToValidate="rblGenero" ValidationGroup="gpAgregar" ForeColor="#CC0000" Display="Dynamic">(*) Seleccione una opción.</asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="rfvCorreoElectronico" CssClass="mb-5" runat="server" ControlToValidate="txtCorreoElectronico" ForeColor="#CC0000" ValidationGroup="gpAgregar" Display="Dynamic">(*) Complete el campo.</asp:RequiredFieldValidator>
        ...
        <asp:RegularExpressionValidator ID="revTelefono" runat="server" ControlToValidate="txtTelefono" ForeColor="#CC0000" ValidationExpression="^\d+$" ValidationGroup="gpAgregar" Display="Dynamic">(*) Ingrese solo números.</asp:RegularExpressionValidator>
