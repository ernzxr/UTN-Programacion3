     ...
     .auto-style1 {
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         ...
         <div style="flex: 1;">
           ...
           <asp:DropDownList ID="ddlAnio" class="form-select" runat="server" Style="width: 100%;"></asp:DropDownList>
             <asp:RequiredFieldValidator ID="rfvAnio" runat="server" ControlToValidate="ddlAnio" ForeColor="#CC0000" ValidationGroup="grupo1">(*) Seleccione una opción.</asp:RequiredFieldValidator>
            </div>
        ...
        <div style="flex: 1;">
          ...
          <asp:DropDownList ID="ddlMes" class="form-select" runat="server" Style="width: 100%;"></asp:DropDownList>
           <asp:RequiredFieldValidator ID="rfvMes" runat="server" ControlToValidate="ddlMes" ForeColor="#CC0000" ValidationGroup="grupo1">(*) Seleccione una opción.</asp:RequiredFieldValidator>
