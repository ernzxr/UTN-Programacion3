...
<div style="width: 100%; display: flex; flex-direction: column; align-items: center; position: relative;">
    ...
    <div style="width: 100%; margin-top: 20px;">
        <asp:GridView runat="server" ID="gvMedicos" CssClass="table table-hover" AutoGenerateColumns="False">
            <Columns>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Modificar Medico</h5>
                ...
                <div class="modal-body">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            <div>
                            <asp:Label ID="lblNacionalidad" Text="Nacionalidad:" runat="server" />
                             <asp:DropDownList ID="ddlNacionalidad_M" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlProvincia_M_SelectedIndexChanged"></asp:DropDownList>
                            </div>
