    ...
    <div class="contenedor">
        ...
        <div class="px-5 py-3">
            ...
            <asp:GridView
                ...
                PagerSettings-PageButtonCount="3" OnRowDeleting="gvTurnos_RowDeleting">

                <Columns>

                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnCancelarTurno" runat="server" CommandName="Delete" Text="Cancelar Turno" CssClass="btn btn-danger" />
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="ID">
                        <ItemTemplate>
                            <asp:Label ID="lblIdTurno" runat="server" Text='<%# Bind("Id_Turno_Tu") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                ...
                <PagerSettings FirstPageText="Inicio" LastPageText="Fin" Mode="NumericFirstLast" PageButtonCount="3"></PagerSettings>

                <PagerStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="gridPager"></PagerStyle>
            </asp:GridView>
